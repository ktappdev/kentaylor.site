...
I didn't even own a computer. I used to go on my uncle's machine from time to time, and somewhere along the line I learned: _oh, you can make stuff do things._ I started with bash programming. Put something on screen with `echo`, and I was hooked.
